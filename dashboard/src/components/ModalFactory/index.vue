<template>
  <teleport to="body">
    <div v-if="state.isActive" @keydown="handleModalToogle({ status: false })" class="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
      <div class="fixed mx-10" :class="state.width" @keydown.stop>
...
const DEFAULT_WIDTH = 'w3/4 lg:w-1/3'
