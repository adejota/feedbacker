<template>
  ...
  <div class="flex flex-col items-center justify-center h-64 bg-brand-gray">
    ...
    <p class="text-lg font-regular text-center text-gray-800">Guia de instalação e geração de suas credenciais</p>
  </div>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div v-else class="flex py-3 pl-5 pr-2 mt-2 rounded justify-between items-center bg-brand-gray w-full md:w-1/2">
